...
2. If you're using a **common 3rd party** like Youtube, Vimeo or [others supported in AMP](https://github.com/ampproject/amphtml/blob/master/extensions/amp-video-iframe/../../spec/amp-video-interface.md), you should use their supported component (e.g. [`amp-youtube`](https://amp.dev/documentation/components/amp-youtube), [`amp-vimeo`](https://amp.dev/documentation/components/amp-vimeo)).
...
3. If you've built a **custom player** or are using one provided by an **unsupported 3rd party**, **you should use `amp-video-iframe`**. This is different from using [`amp-iframe`](https://amp.dev/documentation/components/amp-iframe) in that it enables
   [Video Features on AMP](https://github.com/ampproject/amphtml/blob/master/extensions/amp-video-iframe/../../spec/amp-video-interface.md). See [behavior](#behavior) below for more details.
...
If you're a vendor that does _not_ provide a [custom video player component](https://github.com/ampproject/amphtml/blob/master/extensions/amp-video-iframe/../../spec/amp-video-interface.md), you can integrate with AMP in the form of an `amp-video-iframe` configuration, so authors can embed video provided through your service.

Note: For most video providers, `amp-video-iframe` provides enough tools for common playback actions (see [methods](#method) and [events](#postEvent)). Refer to the [vendor player spec](https://github.com/ampproject/amphtml/blob/master/extensions/amp-video-iframe/../../spec/amp-3p-video.md) for more details on whether you can use `amp-video-iframe` or you should build a third-party player component instead.
...
### Readymade integrations <a name="readymade-integrations"></a>
...
### Custom integrations <a name="custom-integrations"></a>

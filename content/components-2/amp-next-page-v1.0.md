...
The `amp-next-page` `src` allows all standard URL variable substitutions. See the [Substitutions Guide](https://github.com/ampproject/amphtml/blob/master/extensions/amp-next-page/../../spec/amp-var-substitutions.md) for more info. For example:
  ...
  <div recommendation-box class="my-custom-recommendation-box">
    ...
    <template type="amp-mustache">
      <div class="recommendation-box-content">
        ...
        <span class="url">{% raw %}{{url}}{% endraw %}</span>
        <span class="image">{% raw %}{{image}}{% endraw %}</span>
        {% raw %}{{/pages}}{% endraw %}
      </div>
    </template>
  </div>
  ...
  <div separator class="my-custom-separator">
    <template type="amp-mustache">
      <div class="my-custom-separator-content">
        <amp-img
          src="{% raw %}{{image}}{% endraw %}"
          layout="fixed"
          height="16"
          width="16"
        ></amp-img>
        <span>Next article: {% raw %}{{title}}{% endraw %}</span>
      </div>
    </template>
  </div>
</amp-next-page>

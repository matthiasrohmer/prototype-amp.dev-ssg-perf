...
## Story: `amp-story` <a name="story-amp-story"></a>
...
#### Poster guidelines (for `poster-portrait-src`, `poster-landscape-src`, and `poster-square-src`) <a name="poster-guidelines-for-poster-portrait-src-poster-landscape-src-and-poster-square-src"></a>
...
### Live story <a name="live-story"></a>
...
### Animation effects <a name="animation-effects"></a>
...
### Animation attributes <a name="animation-attributes"></a>
...
### Sequencing animations <a name="sequencing-animations"></a>
...
## Integration with Sidebar for Stories <a name="integration-with-sidebar-for-stories"></a>

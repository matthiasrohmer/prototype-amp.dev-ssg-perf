...
teaser:
  text: >-
    Provides configurable behavior for ad exits for [AMPHTML
    ads](https://amp.dev/documentation/guides-and-tutorials/learn/intro-to-amphtml-ads).
toc: true
layout: default.njk
title: amp-ad-exit
version: '0.1'
...
scripts:
  - >-
    <script async custom-element="amp-ad-exit"
    src="https://cdn.ampproject.org/v0/amp-ad-exit-0.1.js"></script>
---

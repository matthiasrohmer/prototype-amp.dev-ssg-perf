...
[tip type="important"]
**Important** [`<amp-analytics>`](https://github.com/ampproject/amphtml/blob/master/extensions/amp-next-page/0.1/../../amp-analytics/amp-analytics.md) is [currently unsupported](https://github.com/ampproject/amphtml/issues/15807) on pages users land on through `<amp-next-page>`.
Tracking page views is supported through [`<amp-pixel>`](https://github.com/ampproject/amphtml/blob/master/extensions/amp-next-page/0.1/../../../builtins/amp-pixel.md) or `<amp-analytics>` on the host page.
[/tip]
...
<br><br>
[tip type="important"] Your endpoint must implement
...
the [Substitutions Guide](https://github.com/ampproject/amphtml/blob/master/extensions/amp-next-page/0.1/../../../spec/amp-var-substitutions.md) for more info.

...
The `amp-subscriptions` extension is similar to [`amp-access`](https://github.com/ampproject/amphtml/blob/master/extensions/amp-subscriptions/../amp-access/amp-access.md)
...
## Selecting a service <a name="selecting-a-service"></a>
...
See [amp-access-iframe](https://github.com/ampproject/amphtml/blob/master/extensions/amp-subscriptions/../amp-access/0.1/iframe-api/README.md) for details of the messaging protocol.
...
### Action delegation <a name="action-delegation"></a>
...
<template type="amp-mustache" subscriptions-dialog subscriptions-display="EXPR">
  <div>
    You have {% raw %}{{metering.left}}{% endraw %} articles left this month.
  </div>
</template>
[/sourcecode]
...
The `subscriptions-display` attribute uses expressions for actions and dialogs. The value of `subscriptions-display` is a boolean expression defined in a SQL-like language. The grammar is defined in [amp-access Appendix A](https://github.com/ampproject/amphtml/blob/master/extensions/amp-subscriptions/../amp-access/amp-access.md#appendix-a-amp-access-expression-grammar).
